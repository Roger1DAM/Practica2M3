...
public class Soci extends Persona implements Comparable<Soci>, Comparator<Soci>, Serializable{
    private static int numLocalitat = 500;
    private static int numSocis = 1;
    private int numSoci;
    ...
    public Soci modificarSoci(Soci soci) {
    ...
    private static int assignarNumLocalitat() {
        return numLocalitat++;
    }

    private static int assignarNumSoci() {
        return numSocis++;
    }
    ...
    public Soci(Dni dni, String nom, String cognom1, String cognom2, LocalDate data_naix, Telefon telefon, Correu email, double quota) {
        ...
        this.localitat = assignarNumLocalitat();
        this.numSoci = assignarNumSoci();
        this.quota = quota;
    }
